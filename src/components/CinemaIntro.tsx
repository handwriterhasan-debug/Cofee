...
export default function CinemaIntro({ onExplore }: CinemaIntroProps) {
  ...
  return (
    <div
      ...
      className="fixed inset-0 z-50 flex flex-col items-center justify-between overflow-hidden bg-white py-12 px-6 select-none"
    >
      ...
      >
        <div className="flex items-center space-x-1.5">
          ...
          <span className="font-mono text-[9px] uppercase tracking-widest text-neutral-500 font-extrabold">
      ...
      <div className="relative flex-1 w-full max-w-4xl flex items-center justify-center my-4 overflow-hidden px-4 md:px-0">
        ...
        <div className="absolute w-[80%] h-[70%] bg-black/5 rounded-full filter blur-[100px] pointer-events-none" />
        ...
        <motion.div
          ...
          className="relative w-full aspect-[16/9] overflow-hidden rounded-2xl md:rounded-3xl shadow-2xl shadow-black/15 ring-1 ring-black/5 flex items-center justify-center bg-neutral-900"
        >
          <video
      ...
      >
        <button
          ...
          onClick={onExplore}
          className="group w-full relative overflow-hidden bg-black hover:bg-neutral-800 text-white py-4.5 px-8 rounded-full font-sans text-xs font-black tracking-widest uppercase transition-all duration-350 shadow-lg shadow-black/20 flex items-center justify-center space-x-3 cursor-pointer transform hover:scale-[1.03] active:scale-[0.98]"
        >
          ...
          <Coffee className="w-4 h-4 text-white/80 group-hover:rotate-12 transition-transform duration-300" />
          
          <span className="relative z-10 tracking-[0.25em]">Explore KAF Coffee</span>
          
          <ArrowRight className="w-4 h-4 text-white/80 group-hover:translate-x-1.5 transition-transform duration-300" />
        </button>
